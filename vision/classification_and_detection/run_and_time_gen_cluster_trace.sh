...
SRC_DIR="/scratch/gpfs/hm2595/mlperf/mlperf-inference/vision/classification_and_detection"
...
OUTPUT_DIR=/scratch/gpfs/hm2595/value_locality_detector/output/mlperf/imgclassify/$name
...
opts="--mlperf_conf /scratch/gpfs/hm2595/mlperf/mlperf-inference/vision/classification_and_detection/mlperf.conf --user_conf /scratch/gpfs/hm2595/mlperf/mlperf-inference/vision/classification_and_detection/user.conf --profile $profile $common_opt --model $model_path \
...
$SRC_DIR/${image}.sif \
/mlperf/run_helper_gen_cluster_trace.sh 2>&1
